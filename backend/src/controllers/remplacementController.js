...
/**
 * Déclarer une absence (création d’une demande)
 */
export const demanderRemplacement = async (req, res) =>
{
    try
    {
        ...
        // Insérer la demande de remplacement
        await query(
...
/**
 * Calcul des enseignants disponibles (Neo4j = intelligence)
 */
export const getEnseignantsDisponibles = async (req, res) =>
{
    try
    {
        ...
        // Requête Neo4j pour trouver les enseignants disponibles (à améliorer!!!)
...
export const accepterRemplacement = async (req, res) =>
{
    ...
    try
    {
        ...
        // 5. Synchronisation Neo4j avec transaction explicite : création des relations et mise à jour des nœuds
