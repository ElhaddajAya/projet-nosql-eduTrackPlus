...
export default function AbsenceDeclaration({
  ...
  const teacherAbsences = teacherAttendances.filter(
          ...
          <CardContent className='space-y-4'>
            ...
            <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
              <p className='text-sm text-blue-800'>
                <strong>Note:</strong> Un remplaçant sera automatiquement
                assigné si un professeur enseignant la même matière est
                disponible à cet horaire.
              </p>
            </div>
        ...
        <CardContent>
          <ul className='space-y-2 text-sm text-gray-600'>
            <li className='flex items-start gap-2'>
              ...
              <span>
                Déclarez votre absence le plus tôt possible pour faciliter
            ...
            <li className='flex items-start gap-2'>
              <span className='text-green-600 mt-1'>•</span>
              <span>
                Fournissez un motif clair et précis pour votre absence
              </span>
            </li>
            <li className='flex items-start gap-2'>
              <span className='text-green-600 mt-1'>•</span>
